...
//        house.setHouseNumber(houseTextField);
    ...
    private void populatePatientDetails(Patient patient){
        ...
        String data[] = {patient.getFirstName(),patient.getLastName(),patient.getGender(),String.valueOf(patient.getAge()),patient.getPatientType(),patient.getPhone(),patient.getEmail(),patient.getHouse().getStreetName(),patient.getCommunity().getCommunityName(),patient.getCity().getCityName()};
